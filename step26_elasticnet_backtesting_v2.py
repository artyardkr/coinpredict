#!/usr/bin/env python3
"""
Step 26 V2: ElasticNet Backtesting with Performance Metrics (138 Features)
...
V2 Changes:
- 138 features (88 original + 50 new)
- Added Fed liquidity, ETF flows, advanced on-chain metrics
"""
...
# ========================================
print("=" * 80)
print("ElasticNet Backtesting V2 (138 Features)")
print("=" * 80)
...
print(f"Features: {len(feature_cols)} (V2: 138 features)")
...
# ========================================
print("\n" + "=" * 80)
print("RESULTS SUMMARY (V2: 138 Features)")
print("=" * 80)
...
ax1.set_title('Portfolio Value Over Time (V2: 138 Features)', fontweight='bold', fontsize=13)
ax1.legend(loc='best')
...
plt.savefig('elasticnet_backtesting_results_v2.png', dpi=300, bbox_inches='tight')
print("Saved: elasticnet_backtesting_results_v2.png")

# ========================================
# 6. Save Results
# ========================================
results_save = results_df.drop(columns=['portfolio_values'])
results_save.to_csv('elasticnet_backtesting_results_v2.csv', index=False)
print("Saved: elasticnet_backtesting_results_v2.csv")

# ========================================
# 7. Final Analysis
# ========================================
print("\n" + "=" * 80)
print("FINAL ANALYSIS (V2)")
print("=" * 80)
...
print(f"""
📊 ElasticNet V2 백테스팅 결과 분석 (138 Features)
...
6. V2 개선사항:
   - Fed 유동성 지표 (WALCL, RRPONTSYD, FED_NET_LIQUIDITY)
   - Bitcoin ETF 플로우 (IBIT, FBTC, GBTC Premium)
   - 고급 온체인 지표 (NVT, Puell Multiple, Hash Ribbon)
   - 추가 전통시장 (DXY, ETH, TLT, GLD)
""")

print("\n" + "=" * 80)
print("Step 26 V2 Completed!")
print("=" * 80)
